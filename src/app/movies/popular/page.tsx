...
export default function PopularMoviesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const moviesData = await fetchTrendingMovies(currentPage);
        setData(moviesData);
      } catch (error) {
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.contentWrapper}>
        <h1 className={styles.pageTitle}>Popular Movies</h1>
        ...
        {loading ? (
          ...
          <div className={styles.errorContainer}>
            ...
            <button 
              ...
              onClick={() => fetchTrendingMovies(currentPage).then(setData)}
            >
              Retry
            </button>
          </div>
