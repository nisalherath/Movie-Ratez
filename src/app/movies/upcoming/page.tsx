...
export default function PopularMoviesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const moviesData = await fetchUpcomingMovies(currentPage);
        setData(moviesData);
      } catch (error) {
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.contentWrapper}>
        <h1 className={styles.pageTitle}>Upcoming Movies</h1>
        ...
        {loading ? (
          ...
          <div className={styles.errorContainer}>
            ...
            <button 
              ...
              onClick={() => fetchUpcomingMovies(currentPage).then(setData)}
            >
              Retry
            </button>
          </div>
