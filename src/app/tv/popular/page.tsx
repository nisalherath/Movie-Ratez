...
export default function PopularTVShowsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const tvShowsData = await fetchPopularTVShows(currentPage);
        setData(tvShowsData);
      } catch (error) {
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.contentWrapper}>
        <h1 className={styles.pageTitle}>Popular Tv Shows</h1>
        ...
        {loading ? (
          ...
          <div className={styles.errorContainer}>
            ...
            <button 
              ...
              onClick={() => fetchPopularTVShows(currentPage).then(setData)}
            >
              Retry
            </button>
          </div>
