...
export default function PopularMoviesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const moviesData = await fetchNowPlayingMovies(currentPage);
        setData(moviesData);
      } catch (error) {
  ...
  return (
    <div className={styles.pageContainer}>
      <div className={styles.contentWrapper}>
        <h1 className={styles.pageTitle}>Now Playing Movies</h1>
        ...
        {loading ? (
          ...
          <div className={styles.errorContainer}>
            ...
            <button 
              ...
              onClick={() => fetchNowPlayingMovies(currentPage).then(setData)}
            >
              Retry
            </button>
          </div>
